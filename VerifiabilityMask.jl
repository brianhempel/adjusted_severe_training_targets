...
if get(ARGS, 1, "") == "sig"
  ...
  reported = read_3rd_col(estimated_reweighted_plus_measured_sig_report_fourhours_per_year_grid_130_cropped_blurred_path(1))
else
  target   = read_3rd_col(asos_gust_fourhours_per_year_grid_130_cropped_blurred_path)
  reported = read_3rd_col(estimated_reweighted_plus_measured_report_fourhours_per_year_grid_130_cropped_blurred_path(1))
end
